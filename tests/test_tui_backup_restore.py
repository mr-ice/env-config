...
class TestArchiveListForDisplay:
    ...
    def test_reads_manifests(self, tmp_path, monkeypatch):
        ...
        from env_config.backup import create_backup, list_archives
...
def _cli_backup_env(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr("env_config.cli._discover_files", _fake_discover)
...
class TestCLIBackupTUI:
    ...
    def test_backup_tui_receives_all_families(self, _cli_backup_env, monkeypatch):
        ...
        monkeypatch.setattr("env_config.tui.display_backup_tui", fake_tui)
...
class TestCLIRestoreTUI:
    ...
    def test_restore_tui_called(self, _cli_backup_env, monkeypatch):
        ...
        monkeypatch.setattr("env_config.tui.display_restore_tui", fake_tui)
        from env_config.cli import main
